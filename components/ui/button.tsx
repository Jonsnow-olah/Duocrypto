...

  {
    variants: {
      variant: {
        ...
        sidebar: "bg-transparent text-slate-500 border-2 border-transparent hover:bg-slate transition-none",
        sidebarOutline: "bg-sky-500/15 text-sky-500 border-sky-300 border-2 hover:bg-sky-500/2 transition-none",
